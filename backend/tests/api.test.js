...
// Тепер мок обробляє запити як для events, так і для user_settings.
// ==========================================
...
// Патерни: Repository, Singleton (CurrencyService)
// =======================================================
...
describe('Тестування збереження валютних налаштувань', () => {
    ...
    it('TC-08: Повернення дефолту (UAH) якщо налаштувань ще немає', async () => {
        // Для нового юзера (ID=999) налаштувань ще не існує
        const res = await request(app)
    ...
    it('TC-09: Отримання списку підтримуваних валют', async () => {
        ...
        // Перевіряємо структуру кожної валюти
